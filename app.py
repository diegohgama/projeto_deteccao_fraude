...
# 2. Capturando informações da transacao
...
if st.button("Verificar se é Fraude"):
    # Construir o array reshape adequado para o modelo
    ...
    st.write(f"Probabilidade de Não fraude: **{proba[0][0]:.2%}**")
    st.write(f"**Probabilidade de fraude:** **{proba[0][1]:.2%}**")
